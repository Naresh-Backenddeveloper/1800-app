...
<div class="container">
    <div class="form-section">
        <h4>{{ isset($data) ? 'Edit Sub-Category' : 'Add New Sub-Category' }}</h4>
        ...
        <form action="{{ isset($data) 
            ? url('_admin/secure/categories/sub/edit/' . $data->id) 
            : url('_admin/secure/categories/sub/add/'. $id) }}"
            ...
            <div class="row mb-3">
                <div class="col-md-8 col-lg-6">
                    ...
                    <input
                        ...
                        value="{{ old('name', isset($data) ? $data->sub_categorie : '') }}"
            ...
            <div class="d-flex gap-3 mt-4 pt-3">
                <button type="submit" class="btn btn-custom-primary">
                    {{ isset($data) ? 'Update Sub-Category' : 'Add Sub-Category' }}
                </button>

                <a href="{{ url('_admin/secure/categories') }}" class="text-decoration-none">
