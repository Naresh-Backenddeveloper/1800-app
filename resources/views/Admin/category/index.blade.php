...
<div class="p-6 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Category Management</h1>
        ...
        <button type="button"
            ...
            <a href="{{url('_admin/secure/categories/add')}}"><span class="text-xl">➕</span> Add Category</a>
        </button>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            ...
            <p class="text-3xl font-bold mt-1 text-emerald-600">{{ $stats['main'] ?? 0 }}</p>
        </div>
            ...
            <table class="w-full min-w-max divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3.5 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Category Name</th>
                ...
                <tbody class="bg-white divide-y divide-gray-100">
                    ...
                    <tr class="{{ $category->parent_id ? 'bg-gray-50/60' : '' }} hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <button type="button"
                                class="text-emerald-600 hover:text-emerald-800 px-2"><a href="{{url('_admin/secure/categories/edit/'.$category->id)}}">Edit</a></button>

                            <button type="button"
                                class="text-blue-600 hover:text-blue-800 px-2"><a href="{{url('_admin/secure/categories/sub/'.$category->id)}}">+ Sub-Categories </a></button>

                            <button type="button"
                                class="text-red-600 hover:text-red-800 px-2"><a href="{{url('_admin/secure/categories/delete/'.$category->id)}}">Delete </a></button>
                        </td>
                    </tr>
                    @empty
                    <tr>
