...
<div class="container">
    <div class="form-section">
        <h4>{{ isset($data) ? 'Edit Specification' : 'Add New Specification' }}</h4>
        ...
        <form action="{{ isset($data) 
            ? url('_admin/secure/categories/specification/edit/' . $data->id) 
            : url('_admin/secure/categories/specification/add/'.$category->id) }}"
            ...
            <div class="row mb-3">
                <div class="col-md-8 col-lg-6">
                    ...
                    <input
                        ...
                        value="{{ old('specification', isset($data) ? $data->specification : '') }}"
            ...
            <div class="d-flex gap-3 mt-4 pt-3">
                <button type="submit" class="btn btn-custom-primary">
                    {{ isset($data) ? 'Update Specification' : 'Add Specification' }}
                </button>
